    ...
    <nav class="my-2 my-md-0 mr-md-3">
        ...
        <?php } else { ?>
                <?php if($_SESSION['role'] == "Patient"){ ?>
                    <a class="p-2 text-dark" href="./patients.php">Dashboard</a>
               <?php } ?>
               <?php if($_SESSION['role'] == "Medical Team (MT)"){ ?>
                    <a class="p-2 text-dark" href="./medical.php">Dashboard</a>
               <?php } ?>
               <?php if($_SESSION['role'] == "Super Admin"){ ?>
                    <a class="p-2 text-dark" href="./admin/dashboard.php">Dashboard</a>
               <?php } ?>          
